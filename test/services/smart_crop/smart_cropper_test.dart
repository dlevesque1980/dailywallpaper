  ...
  group('SmartCropper', () {
    ...
    group('analyzeCrop', () {
      ...
      test('should handle different aspect ratios', () async {
        ...
        final wideAspectRatio =
            wideResult.bestCrop.width / wideResult.bestCrop.height;
        final tallAspectRatio =
            tallResult.bestCrop.width / tallResult.bestCrop.height;
    ...
    group('cache management', () {
      test('should cache and retrieve crop coordinates', () async {
        ...
        final initialCached =
            await SmartCropper.getCachedCrop(imageUrl, targetSize, settings);
        expect(initialCached, isNull);

        // Cache the coordinates
        final cached = await SmartCropper.cacheCrop(
      ...
      test('should provide cache statistics', () async {
        ...
        await SmartCropper.cacheCrop(
          ...
          const CropCoordinates(
              x: 0, y: 0, width: 1, height: 1, confidence: 1, strategy: 'test'),
        );
        await SmartCropper.cacheCrop(
    ...
    group('error handling and fallbacks', () {
      ...
      test('should handle memory estimation errors gracefully', () async {
        ...
        final memoryUsage =
            SmartCropper.estimateMemoryUsage(testImage, targetSize);
      ...
      test('should validate fallback crop coordinates', () async {
        ...
        expect(
            result.bestCrop.x + result.bestCrop.width, lessThanOrEqualTo(1.0));
        expect(
            result.bestCrop.y + result.bestCrop.height, lessThanOrEqualTo(1.0));
      });
    });
    ...
    group('applyCrop', () {
      test('should crop image correctly', () async {
        ...
        final croppedImage =
            await SmartCropper.applyCrop(testImage, cropCoordinates);
