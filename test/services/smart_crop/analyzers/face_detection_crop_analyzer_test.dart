...
void main() {
  group('FaceDetectionCropAnalyzer', () {
    late FaceDetectionCropAnalyzer analyzer;

    setUp(() {
      analyzer = FaceDetectionCropAnalyzer();
    });
    ...
    group('Basic Functionality', () {
      testWidgets('should return valid crop score for simple image',
        ...
        expect(result.strategy, equals('face_detection'));
      ...
      testWidgets('should include face metrics in results',
          (WidgetTester tester) async {
        final image = _createMockImage(400, 300);
        final targetSize = const ui.Size(200, 150);
        ...
        expect(result.metrics, containsPair('faces_detected', isA<double>()));
        expect(result.metrics, containsPair('face_count', isA<double>()));
    ...
    group('Error Handling', () {
      testWidgets('should handle analysis errors gracefully',
          (WidgetTester tester) async {
        // Create a very small mock image that might cause issues
      ...
      testWidgets('should provide fallback crop when face detection fails',
          (WidgetTester tester) async {
    ...
    group('Performance', () {
      testWidgets('should complete analysis within reasonable time',
        ...
        expect(stopwatch.elapsedMilliseconds,
            lessThan(5000)); // Should complete within 5 seconds for mock
      });
    });
