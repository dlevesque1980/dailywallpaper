  ...
  group('Smart Crop Final Integration Tests', () {
    ...
    group('Settings Integration', () {
      ...
      test('should work with minimal settings', () async {
        ...
        expect(result.bestCrop.isValid, isTrue);
        // Avec le nouvel analyseur de paysage, la stratégie peut être différente
        expect(result.bestCrop.strategy,
            isIn(['landscape_aware', 'center_weighted', 'rule_of_thirds']));
      });
    ...
    group('Error Handling and Fallbacks', () {
      ...
      test('should handle timeout scenarios', () async {
        ...
        expect(result.bestCrop.isValid, isTrue);
        // With the new landscape analyzer, processing might take longer
