...
void main() {
  group('Cache Integration Tests', () {
    ...
    test(
        'should cache crop results and improve performance on subsequent calls',
        () async {
    ...
    test('should handle cache invalidation correctly', () async {
      ...
      final result1 = await SmartCropper.analyzeCrop(
          imageUrl, testImage, targetSize, settings1);
      expect(result1.fromCache, isFalse);
      ...
      final result3 = await SmartCropper.analyzeCrop(
          imageUrl, testImage, targetSize, settings2);
      ...
      final result4 = await SmartCropper.analyzeCrop(
          imageUrl, testImage, targetSize, settings1);
    ...
    test('should handle cache maintenance operations', () async {
      ...
      expect(
          maintenanceResult['total_entries_deleted'], greaterThanOrEqualTo(0));
