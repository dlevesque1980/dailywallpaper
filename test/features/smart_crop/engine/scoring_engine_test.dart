...
import 'package:dailywallpaper/features/smart_crop/engine/scoring_engine.dart';
...
import 'package:dailywallpaper/features/smart_crop/registry/analyzer_registry.dart';
...
void main() {
  group('ScoringEngine', () {
    ...
    test('selectBestCrop picks the highest score', () {
      ...
      final result =
          engine.selectBestCrop(scores, CropSettings.defaultSettings);
    ...
    test('selectBestCrop applies consensus with center_weighted', () {
      ...
      registry
          .registerAnalyzer(FakeCropAnalyzer('center_weighted', weight: 1.0));
    ...
    test('selectBestCrop throws if scores are empty', () {
      expect(() => engine.selectBestCrop([], CropSettings.defaultSettings),
          throwsStateError);
    });
  });
}
