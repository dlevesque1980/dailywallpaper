...
import 'package:dailywallpaper/features/smart_crop/analyzers/subject/subject_scoring_logic.dart';
import 'package:dailywallpaper/features/smart_crop/analyzers/subject/subject_detector.dart';
  ...
  group('SubjectScoringLogic', () {
    ...
    test('scoreSubjectCrop handles full inclusion', () {
      ...
      final score = SubjectScoringLogic.scoreSubjectCrop(
          crop, subject, 1.0, 1.0, const ui.Size(100, 100));
