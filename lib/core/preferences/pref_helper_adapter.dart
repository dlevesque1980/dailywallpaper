...
class PrefHelperAdapter implements PreferencesReader {
  ...
  Future<bool> setBool(String key, bool value) =>
      PrefHelper.setBool(key, value);

  @override
  Future<bool> getBoolWithDefault(String key, bool defValue) =>
      PrefHelper.getBoolWithDefault(key, defValue);
  ...
  Future<bool> setString(String key, String value) =>
      PrefHelper.setString(key, value);

  @override
  Future<String> getStringWithDefault(String key, String defValue) =>
      PrefHelper.getStringWithDefault(key, defValue);

  @override
  Future<List<String>?> getStringList(String key) =>
      PrefHelper.getStringList(key);

  @override
  Future<bool> setStringList(String key, List<String> value) =>
      PrefHelper.setStringList(key, value);

  @override
  Future<List<String>> getStringListWithDefault(
          String key, List<String> defValue) =>
      PrefHelper.getStringListWithDefault(key, defValue);
  ...
  Future<int> getIntWithDefault(String key, int defValue) =>
      PrefHelper.getIntWithDefault(key, defValue);
