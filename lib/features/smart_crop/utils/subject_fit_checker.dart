...
class SubjectFitChecker {
  ...
  static SubjectFitResult checkSubjectFit(
    ...
    final absSubjectBoundsOrig =
        ui.Rect.fromLTWH(absSubX, absSubY, absSubW, absSubH);
    final absSubjectBoundsPadded =
        ui.Rect.fromLTWH(paddedSubX, paddedSubY, paddedSubW, paddedSubH);
    ...
    */
    ...
    final finalIntersectionArea = math.max(0.0, finalIntersection.width) *
        math.max(0.0, finalIntersection.height);
    final finalCoverage =
        subjectArea > 0 ? finalIntersectionArea / subjectArea : 1.0;
