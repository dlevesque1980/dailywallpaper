...
class ImageUtils {
  ...
  static Future<ui.Image> downscaleForAnalysis(ui.Image image,
  ...
  static CropCoordinates validateAndClampCoordinates(
    ...
    final clampedHeight =
        math.max(0.01, math.min(maxHeight, coordinates.height));
    final clampedConfidence =
        math.max(0.0, math.min(1.0, coordinates.confidence));
