...
class PexelsCategoriesBloc
    extends Bloc<PexelsCategoriesEvent, PexelsCategoriesState> {
  ...
  Future<void> _onStarted(PexelsCategoriesEventStarted event,
      Emitter<PexelsCategoriesState> emit) async {
  ...
  Future<void> _onCategoriesChanged(
      PexelsCategoriesEventCategoriesChanged event,
      Emitter<PexelsCategoriesState> emit) async {
